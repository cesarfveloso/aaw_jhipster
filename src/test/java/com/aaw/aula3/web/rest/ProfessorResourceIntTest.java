...
import com.aaw.aula3.repository.ProfessorRepository;
...
public class ProfessorResourceIntTest {
    ...
    private static final String DEFAULT_TITULO_FORMACAO = "AAAAAAAAAA";
    private static final String UPDATED_TITULO_FORMACAO = "BBBBBBBBBB";

    private static final String DEFAULT_AREA_CONHECIMENTO = "AAAAAAAAAA";
    private static final String UPDATED_AREA_CONHECIMENTO = "BBBBBBBBBB";
    ...
    public static Professor createEntity(EntityManager em) {
        Professor professor = new Professor()
            .nome(DEFAULT_NOME)
            .tituloFormacao(DEFAULT_TITULO_FORMACAO)
            .areaConhecimento(DEFAULT_AREA_CONHECIMENTO);
        return professor;
    }
    ...
    public void createProfessor() throws Exception {
        ...
        assertThat(testProfessor.getTituloFormacao()).isEqualTo(DEFAULT_TITULO_FORMACAO);
        assertThat(testProfessor.getAreaConhecimento()).isEqualTo(DEFAULT_AREA_CONHECIMENTO);
    }
    ...
    public void getAllProfessors() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tituloFormacao").value(hasItem(DEFAULT_TITULO_FORMACAO.toString())))
            .andExpect(jsonPath("$.[*].areaConhecimento").value(hasItem(DEFAULT_AREA_CONHECIMENTO.toString())));
    }
    ...
    public void getProfessor() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors/{id}", professor.getId()))
            ...
            .andExpect(jsonPath("$.tituloFormacao").value(DEFAULT_TITULO_FORMACAO.toString()))
            .andExpect(jsonPath("$.areaConhecimento").value(DEFAULT_AREA_CONHECIMENTO.toString()));
    }
    ...
    public void updateProfessor() throws Exception {
        ...
        updatedProfessor
            .nome(UPDATED_NOME)
            .tituloFormacao(UPDATED_TITULO_FORMACAO)
            .areaConhecimento(UPDATED_AREA_CONHECIMENTO);
        ...
        assertThat(testProfessor.getTituloFormacao()).isEqualTo(UPDATED_TITULO_FORMACAO);
        assertThat(testProfessor.getAreaConhecimento()).isEqualTo(UPDATED_AREA_CONHECIMENTO);
    }
