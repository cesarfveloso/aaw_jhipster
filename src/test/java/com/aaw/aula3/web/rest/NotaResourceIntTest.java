...
import com.aaw.aula3.repository.NotaRepository;
...
public class NotaResourceIntTest {
    ...
    private static final String DEFAULT_DATA_AVALIACAO = "AAAAAAAAAA";
    private static final String UPDATED_DATA_AVALIACAO = "BBBBBBBBBB";
    ...
    public static Nota createEntity(EntityManager em) {
        Nota nota = new Nota()
            .valor(DEFAULT_VALOR)
            .dataAvaliacao(DEFAULT_DATA_AVALIACAO);
        return nota;
    }
    ...
    public void createNota() throws Exception {
        ...
        assertThat(testNota.getDataAvaliacao()).isEqualTo(DEFAULT_DATA_AVALIACAO);
    }
    ...
    public void getAllNotas() throws Exception {
        ...
        restNotaMockMvc.perform(get("/api/notas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dataAvaliacao").value(hasItem(DEFAULT_DATA_AVALIACAO.toString())));
    }
    ...
    public void getNota() throws Exception {
        ...
        restNotaMockMvc.perform(get("/api/notas/{id}", nota.getId()))
            ...
            .andExpect(jsonPath("$.dataAvaliacao").value(DEFAULT_DATA_AVALIACAO.toString()));
    }
    ...
    public void updateNota() throws Exception {
        ...
        updatedNota
            .valor(UPDATED_VALOR)
            .dataAvaliacao(UPDATED_DATA_AVALIACAO);
        ...
        assertThat(testNota.getDataAvaliacao()).isEqualTo(UPDATED_DATA_AVALIACAO);
    }
